...
async def search(search_request: SearchRequest):
    results = search_posts(book_title=search_request.book_title, author=search_request.author, publisher=search_request.publisher, location=search_request.location, min_price=search_request.min_price, max_price=search_request.max_price)
